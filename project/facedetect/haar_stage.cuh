...
void cascadeClassifierOnDevice(MyImage* pimg1, 
                               int pbitvec_width, int pbitvec_height,
                               uint16_t* pdindex_x, uint16_t* pdindex_y,
                               uint16_t* pdwidth,   uint16_t* pdheight,
                               int16_t* pdweights_array, int16_t* pdtree_thresh_array,
                               int16_t* pdalpha1_array, int16_t* pdalpha2_array,  
                               int16_t* pdstages_thresh_array,
                               int32_t* pdevicesum1, int32_t* pdevicesqsum1, 
                               int* pdstages_array,
                               bool* pdbit_vector
                              )
{
     ...
     MyImage* img1 = pimg1;
     int bitvec_width = pbitvec_width;
     int bitvec_height = pbitvec_height;
     uint16_t* dindex_x = pdindex_x; uint16_t* dindex_y = pdindex_y;
     uint16_t* dwidth = pdwidth;   uint16_t* dheight = pdheight;
     int16_t* dweights_array = pdweights_array; int16_t* dtree_thresh_array = pdtree_thresh_array;
     int16_t* dalpha1_array = pdalpha1_array; int16_t* dalpha2_array = pdalpha2_array;
     int16_t* dstages_thresh_array = pdstages_thresh_array;
     int32_t* devicesum1 = pdevicesum1; int32_t* devicesqsum1 = pdevicesqsum1;
     int* dstages_array = pdstages_array;
     bool* dbit_vector = pdbit_vector;
      ...
      printf("numblocks.x: %d, numblocks.y: %d | numthreads.x: %d, numthreads.y: %d\n", numBlocks.x, numBlocks.y, numThreads.x, numThreads.y);
