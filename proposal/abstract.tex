\begin{abstract}
    ...
    \vspace{0.1in}
Applications with large amount of parallelism can benefit from General Purpose Graphics Processing Units or GPGPUs and can perform 
better on a GPU than on a CPU. Due to the nature of the graphics workloads, computer vision algorithms can better utilize the large 
